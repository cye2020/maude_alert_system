...
class SnowflakeBase:
    ...
    def _error_logging(self, operation: str, **context):
        ...
        try:
            ...
            logger.error(f'{operation} 실패', error=str(e), **context)
            raise
    ...
    def get_table_schema(
        ...
        """
        logger.debug('테이블 스키마 조회 시작', table_name=table_name)
    ...
    def transaction(self, cursor: SnowflakeCursor):
        ...
        try:
            ...
            logger.warning('트랜잭션 롤백', error=str(e))
            raise
